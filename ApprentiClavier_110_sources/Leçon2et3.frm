...
typeleçon = 2
Set leçon_courante = Leçon2et3
Module_routines.Colors Leçon2et3  '12/2011
Module_routines.Dimension Leçon2et3
...
Module_routines.mshow Leçon2et3 'avril 2008
...
' Première currentline (après le bip 2 tons, sinon bip inaudible en Win98 ; bipinhibit pour éviter le bip quand on quitte l'exo sur les fautes)
...
Else
    ...
    leçonfontsize = (36 * Leçon2et3.Width) / 11746
    Module_routines.AdjustWidthAndSize Leçon2et3, 1
End If
End Sub

' ********************  LOAD suite ********************************************
Private Sub Timer1_Timer()
f1msgform = 0 'Pour accepter F1 pendant les exercices sur les fautes qui appellent leçon2et3
Leçon2et3.text1.Text = currentline
nbcaras = Len(Leçon2et3.text1.Text)
iwrong = 0: iwrongbis = 0: iter = 0
cara1 = "": cara2 = ""
Leçon2et3.text1.SelStart = 0
Leçon2et3.text1.SelLength = Len(Leçon2et3.text1.Text)
...
If Keycode = 91 Or Keycode = 92 Then
    Module_routines.cancelwin 0, Leçon2et3, 0
    Exit Sub
End If
...
'RetArr interdit
If Keycode = 8 Then
    Module_routines.bip Leçon2et3
    t2inhibit = 1
    ii = ii + 1
    Leçon2et3.text2.Text = Left(Leçon2et3.text1.Text, ii)
    t2inhibit = 0
    Leçon2et3.text2.SelStart = Len(Leçon2et3.text2.Text)
End If
...
If Keycode = 27 Then
    ...
    If keyinhibit = 2 Then
        keyinhibit = 0
        Leçon2et3.text4.Visible = False
        Leçon2et3.text1.SelLength = 0
        Call Sleep(cadencecara)
        
        ' La touche Alt lance Echap qui ne lance la sélection de la fin du text1 que si noalt=0
        If noalt = 1 Then
            Leçon2et3.text1.SelLength = 1
        Else
            Leçon2et3.text1.SelLength = Len(Leçon2et3.text1.Text)
        End If
        Exit Sub
...
If Keycode = 91 Or Keycode = 92 Then
    Module_routines.cancelwin 1, Leçon2et3, 0
    Exit Sub
End If
...
'Touche F1
If Keycode = 112 Then Module_routines.help_f1 Leçon2et3
...
'Touche F3
If Keycode = 114 Then Module_routines.help_f3 Leçon2et3
