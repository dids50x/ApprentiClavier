VERSION 4.00
Begin VB.Form Menu_leçon14 
   BackColor       =   &H00C0C0C0&
   Caption         =   "Menu leçon 14"
   ClientHeight    =   5745
   ClientLeft      =   600
   ClientTop       =   1875
   ClientWidth     =   9825
   ...
   Begin VB.ListBox List1 
      ...
      EndProperty
      Height          =   1785
      ItemData        =   "Menu_leçon14.frx":0000
      Left            =   120
      List            =   "Menu_leçon14.frx":000D
      TabIndex        =   0
      Top             =   960
      Width           =   8070
   End
   ...
   End
End
Attribute VB_Name = "Menu_leçon14"
...
Menu_leçon14.Quitter.Caption = msgQuitterMP & msgÉchap

'Paramètres
If numleçon <> 16 Then numexo = 0
numleçon = 16   ' Toujours leçon n + 2
Set menu_courant = Menu_leçon14
Set menu_suivant = Menu_leçon15
Module_routines.Colors Menu_leçon14  '12/2011
Module_routines.Dimension Menu_leçon14
Module_menus.menu_reset "menu_leçon14.txt"
Module_routines.menu_refresh "menu_courant.txt", Menu_leçon14
Module_routines.mshow Menu_leçon14
Label3.Caption = bannerVersion & ", " & bannerCopyright
Module_routines.niveaux
Module_routines.MenuEditorTrans Menu_leçon14
...
Menu_leçon14.Caption = debexplivalue & bannerMenu & debgenvalue & bannerLeçon & " 14"
Menu_leçon14.label1.Caption = msgChoisissez
...
If list1.ListIndex = 0 Then
    numexo = 0
    Unload Menu_leçon14
    tempo = Dir(vpath & "Leçons\" & nivoRep & "\leçon14A.txt")
    If tempo = "" Then
ML10:
        pagenum = 0
        msgtext0 = CRLF + msgNofic & vpath & "Leçons\" & nivoRep & "\leçon14A.txt. " + perso_methode + pressez
        Msgform.Show 1
...
ML11:
    pagenum = 0
    msgtext0 = CRLF + pg14a0 + pressez
    Msgform.Show 1
    If msgf = 2 Then GoTo ML11
    If msgf = 1 Then
        Module_routines.placeinmsgtext0 "leçon14A.txt"
        vmsgbox = MsgBox(msgtext0, 1, msgDictée & "14 A.")
        If vmsgbox = 2 Then
            keyinhibit = 1
            Menu_leçon14.Show 1
            Exit Sub
        End If
        exo_courant = "leçon14A.txt"
            
        ' Msg d'encouragements et d'explications
        Module_routines.resetmsg
         
        ' Go
        leçon14.Caption = bannerLeçon & " 14 A"  'Pas de point dans le titre, car sono avec ponctuation
        leçon14.Show 1
    End If
    If msgf = 0 Then Menu_leçon14.Show 1
End If
...
If list1.ListIndex = 1 Then
    numexo = 1
    Unload Menu_leçon14
    tempo = Dir(vpath & "Leçons\" & nivoRep & "\leçon14B.txt")
    If tempo = "" Then
ML20:
        pagenum = 0
        msgtext0 = CRLF + msgNofic & vpath & "Leçons\" & nivoRep & "\leçon14B.txt. " + perso_methode + pressez
        Msgform.Show 1
...
ML21:
    pagenum = 0
    msgtext0 = CRLF + pg14b0 + pressez
    Msgform.Show 1
    If msgf = 2 Then GoTo ML21
    If msgf = 1 Then
        Module_routines.placeinmsgtext0 "leçon14B.txt"
        vmsgbox = MsgBox(msgtext0, 1, msgDictée & "14 B.")
        If vmsgbox = 2 Then
            keyinhibit = 1
            Menu_leçon14.Show 1
            Exit Sub
        End If
        exo_courant = "leçon14B.txt"
                        
        ' Msg d'encouragements et d'explications
        Module_routines.resetmsg
            
        ' Go
        leçon14.Caption = bannerLeçon & " 14 B"  'Pas de point dans le titre, car sono avec ponctuation
        leçon14.Show 1
    End If
    If msgf = 0 Then Menu_leçon14.Show 1
End If
...
If list1.ListIndex = 2 Then
    numexo = 2
    Unload Menu_leçon14
    tempo = Dir(vpath & "Leçons\" & nivoRep & "\leçon14C.txt")
    If tempo = "" Then
ML30:
        pagenum = 0
        msgtext0 = CRLF + msgNofic & vpath & "Leçons\" & nivoRep & "\leçon14C.txt. " + perso_methode + pressez
        Msgform.Show 1
...
ML31:
    pagenum = 0
    msgtext0 = CRLF + pg14c0 + pressez
    Msgform.Show 1
    If msgf = 2 Then GoTo ML31
    If msgf = 1 Then
        Module_routines.placeinmsgtext0 "leçon14C.txt"
        vmsgbox = MsgBox(msgtext0, 1, msgDictée & "14 C.")
        If vmsgbox = 2 Then
            keyinhibit = 1
            Menu_leçon14.Show 1
            Exit Sub
        End If
        exo_courant = "leçon14C.txt"
                        
        ' Msg d'encouragements et d'explications
        Module_routines.resetmsg
            
        ' Go
        leçon14.Caption = bannerLeçon & " 14 C"  'Pas de point dans le titre, car sono avec ponctuation
        leçon14.Show 1
    End If
    If msgf = 0 Then Menu_leçon14.Show 1
End If
...
If Keycode = 91 Or Keycode = 92 Then Module_routines.cancelwin 0, Menu_leçon14, 1
End Sub
