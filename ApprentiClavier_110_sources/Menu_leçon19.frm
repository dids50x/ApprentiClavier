VERSION 4.00
Begin VB.Form Menu_leçon19 
   BackColor       =   &H00C0C0C0&
   Caption         =   "Menu leçon 19"
   ClientHeight    =   6030
   ClientLeft      =   585
   ClientTop       =   1935
   ClientWidth     =   9810
   ...
   Begin VB.ListBox List1 
      ...
      EndProperty
      Height          =   2130
      ItemData        =   "Menu_leçon19.frx":0000
      Left            =   120
      List            =   "Menu_leçon19.frx":0010
      TabIndex        =   0
      Top             =   720
      Width           =   8175
   End
   ...
   End
End
Attribute VB_Name = "Menu_leçon19"
Attribute VB_Creatable = False
Attribute VB_Exposed = False
'*****************  LOAD  ************************************************
' MENU : Encore des dictées, plus rapides
Private Sub Form_Load()
If FullScreenSwitch = 1 Then WindowState = 2
Menu_leçon19.Quitter.Caption = msgQuitterMP & msgÉchap

'Paramètres
If numleçon <> 21 Then numexo = 0
numleçon = 21   ' Toujours leçon n + 2
Set menu_courant = Menu_leçon19
Set menu_suivant = Menu_leçon19
Module_routines.Colors Menu_leçon19  '12/2011
Module_routines.Dimension Menu_leçon19
Module_menus.menu_reset "menu_leçon19.txt"
Module_routines.menu_refresh "menu_courant.txt", Menu_leçon19
Module_routines.mshow Menu_leçon19
Label3.Caption = bannerVersion & ", " & bannerCopyright
Module_routines.niveaux
Module_routines.MenuEditorTrans Menu_leçon19
...
Menu_leçon19.Caption = debexplivalue & bannerMenu & debgenvalue & bannerLeçon & " 19"
Menu_leçon19.label1.Caption = msgChoisissez
...
If list1.ListIndex = 0 Then
    numexo = 0
    Unload Menu_leçon19
    tempo = Dir(vpath & "Leçons\" & nivoRep & "\leçon19A.txt")
    If tempo = "" Then
ML10:
        pagenum = 0
        msgtext0 = CRLF + msgNofic & vpath & "Leçons\" & nivoRep & "\leçon19A.txt. " + perso_methode + pressez
        Msgform.Show 1
...
ML11:
    pagenum = 0
    msgtext0 = CRLF + pg19a0 + pressez
    Msgform.Show 1
    If msgf = 2 Then GoTo ML11
    If msgf = 1 Then
        Module_routines.placeinmsgtext0 "leçon19A.txt"
        vmsgbox = MsgBox(msgtext0, 1, msgDictée & "19 A.")
        If vmsgbox = 2 Then
            keyinhibit = 1
            Menu_leçon19.Show 1
            Exit Sub
        End If
        exo_courant = "leçon19A.txt"
            
        ' Msg d'encouragements et d'explications
        Module_routines.resetmsg
         
        ' Go
        leçon14.Caption = bannerLeçon & " 19 A"  'Pas de point final, ar sono avec ponctuation
        leçon14.Show 1
    End If
    If msgf = 0 Then Menu_leçon19.Show 1
End If
...
If list1.ListIndex = 1 Then
    numexo = 1
    Unload Menu_leçon19
    tempo = Dir(vpath & "Leçons\" & nivoRep & "\leçon19B.txt")
    If tempo = "" Then
ML20:
        pagenum = 0
        msgtext0 = CRLF + msgNofic & vpath & "Leçons\" & nivoRep & "\leçon19B.txt. " + perso_methode + pressez
        Msgform.Show 1
...
ML21:
    pagenum = 0
    msgtext0 = CRLF + pg19b0 + pressez
    Msgform.Show 1
    If msgf = 2 Then GoTo ML21
    If msgf = 1 Then
        Module_routines.placeinmsgtext0 "leçon19B.txt"
        vmsgbox = MsgBox(msgtext0, 1, msgDictée & "19 B.")
        If vmsgbox = 2 Then
            keyinhibit = 1
            Menu_leçon19.Show 1
            Exit Sub
        End If
        exo_courant = "leçon19B.txt"
                        
        ' Msg d'encouragements et d'explications
        Module_routines.resetmsg
            
        ' Go
        leçon14.Caption = bannerLeçon & " 19 B"  'Pas de point dans le titre, car sono avec ponctuation
        leçon14.Show 1
    End If
    If msgf = 0 Then Menu_leçon19.Show 1
End If
...
If list1.ListIndex = 2 Then
    numexo = 2
    Unload Menu_leçon19
    tempo = Dir(vpath & "Leçons\" & nivoRep & "\leçon19C.txt")
    If tempo = "" Then
ML30:
        pagenum = 0
        msgtext0 = CRLF + msgNofic & vpath & "Leçons\" & nivoRep & "\leçon19C.txt. " + perso_methode + pressez
        Msgform.Show 1
...
ML31:
    pagenum = 0
    msgtext0 = CRLF + pg19c0 + pressez
    Msgform.Show 1
    If msgf = 2 Then GoTo ML31
    If msgf = 1 Then
        Module_routines.placeinmsgtext0 "leçon19C.txt"
        vmsgbox = MsgBox(msgtext0, 1, msgDictée & "19 C.")
        If vmsgbox = 2 Then
            keyinhibit = 1
            Menu_leçon19.Show 1
            Exit Sub
        End If
        exo_courant = "leçon19C.txt"
                        
        ' Msg d'encouragements et d'explications
        Module_routines.resetmsg
            
        ' Go
        leçon14.Caption = bannerLeçon & " 19 C"  'Pas de point dans le titre, car sono avec ponctuation
        leçon14.Show 1
    End If
    If msgf = 0 Then Menu_leçon19.Show 1
End If
...
If list1.ListIndex = 3 Then
    numexo = 3
    Unload Menu_leçon19
    tempo = Dir(vpath & "Leçons\" & nivoRep & "\leçon19D.txt")
    If tempo = "" Then
ML40:
        pagenum = 0
        msgtext0 = CRLF + msgNofic & vpath & "Leçons\" & nivoRep & "\leçon19D.txt. " + perso_methode + pressez
        Msgform.Show 1
...
ML41:
    pagenum = 0
    msgtext0 = CRLF + pg19d0 + pressez
    Msgform.Show 1
    If msgf = 2 Then GoTo ML41
    If msgf = 1 Then
        Module_routines.placeinmsgtext0 "leçon19D.txt"
        vmsgbox = MsgBox(msgtext0, 1, msgDictée & "19 D.")
        If vmsgbox = 2 Then
            keyinhibit = 1
            Menu_leçon19.Show 1
            Exit Sub
        End If
        exo_courant = "leçon19D.txt"
                        
        ' Msg d'encouragements et d'explications
        Module_routines.resetmsg
            
        ' Go
        leçon14.Caption = bannerLeçon & " 19 D"  'Pas de point dans le titre, car sono avec ponctuation
        leçon14.Show 1
    End If
    If msgf = 0 Then Menu_leçon19.Show 1
End If
...
If Keycode = 91 Or Keycode = 92 Then Module_routines.cancelwin 0, Menu_leçon19, 1
End Sub
