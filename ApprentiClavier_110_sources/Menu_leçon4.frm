VERSION 4.00
Begin VB.Form Menu_leçon4 
   BackColor       =   &H00C0C0C0&
   Caption         =   "Menu leçon 4"
   ClientHeight    =   6105
   ClientLeft      =   615
   ClientTop       =   1890
   ClientWidth     =   9870
   ...
   Begin VB.ListBox List1 
      ...
      EndProperty
      Height          =   3165
      ItemData        =   "Menu_leçon4.frx":0000
      Left            =   360
      List            =   "Menu_leçon4.frx":001C
      TabIndex        =   0
      Top             =   600
      Width           =   6615
   End
...
Menu_leçon4.Quitter.Caption = msgQuitterMP & msgÉchap

'Paramètres
If numleçon <> 6 Then numexo = 0
numleçon = 6   ' Toujours leçon n + 2
Set menu_courant = Menu_leçon4
Set menu_suivant = Menu_leçon5
Module_routines.Colors Menu_leçon4  '12/2011
Module_routines.Dimension Menu_leçon4
Module_menus.menu_reset "menu_leçon4.txt"
Module_routines.menu_refresh "menu_courant.txt", Menu_leçon4
Module_routines.mshow Menu_leçon4
Label3.Caption = bannerVersion & ", " & bannerCopyright
Module_routines.niveaux
Module_routines.MenuEditorTrans Menu_leçon4
...
Menu_leçon4.Caption = debexplivalue & bannerMenu & debgenvalue & bannerLeçon & " 4"
Menu_leçon4.label1.Caption = msgChoisissez
...
If list1.ListIndex = 0 Then
    numexo = 0
    Unload Menu_leçon4
    tempo = Dir(vpath & "Leçons\" & nivoRep & "\leçon4A.txt")
    If tempo = "" Then
ML10:
        pagenum = 0
        msgtext0 = CRLF + msgNofic & vpath & "Leçons\" & nivoRep & "\leçon4A.txt. " + perso_methode + pressez
        Msgform.Show 1
...
ML14:
                ...
                If msgf = 1 Then
                    ...
                    ' Go
                    leçon4.Caption = bannerLeçon & " 4 A."
                    leçon4.Show 1
                End If
            End If
        End If
    End If
    If msgf = 0 Then Menu_leçon4.Show 1
End If

'****************  EXERCICE 4B ********************************************
' MENU : La rangée J K L
If list1.ListIndex = 1 Then
    numexo = 1
    Unload Menu_leçon4
    tempo = Dir(vpath & "Leçons\" & nivoRep & "\leçon4B.txt")
    If tempo = "" Then
ML20:
        pagenum = 0
        msgtext0 = CRLF + msgNofic & vpath & "Leçons\" & nivoRep & "\leçon4B.txt. " + perso_methode + pressez
        Msgform.Show 1
...
ML21:
    ...
    If msgf = 1 Then
        ...
        ' Go
        leçon4.Caption = bannerLeçon & " 4 B."
        leçon4.Show 1
    End If
    If msgf = 0 Then Menu_leçon4.Show 1
End If
...
If list1.ListIndex = 2 Then
    numexo = 2
    Unload Menu_leçon4
    tempo = Dir(vpath & "Leçons\" & nivoRep & "\leçon4C.txt")
    If tempo = "" Then
ML30:
        pagenum = 0
        msgtext0 = CRLF + msgNofic & vpath & "Leçons\" & nivoRep & "\leçon4C.txt. " + perso_methode + pressez
        Msgform.Show 1
...
ML31:
    ...
    If msgf = 1 Then
        ...
        ' Go
        leçon4.Caption = bannerLeçon & " 4 C."
        leçon4.Show 1
    End If
    If msgf = 0 Then Menu_leçon4.Show 1
End If
...
If list1.ListIndex = 3 Then
    numexo = 3
    Unload Menu_leçon4
    tempo = Dir(vpath & "Leçons\" & nivoRep & "\leçon4D.txt")
    If tempo = "" Then
ML40:
        pagenum = 0
        msgtext0 = CRLF + msgNofic & vpath & "Leçons\" & nivoRep & "\leçon4D.txt. " + perso_methode + pressez
        Msgform.Show 1
...
ML41:
    ...
    If msgf = 1 Then
        ...
        ' Go
        leçon4.Caption = bannerLeçon & " 4 D."
        leçon4.Show 1
    End If
    If msgf = 0 Then Menu_leçon4.Show 1
End If
...
If list1.ListIndex = 4 Then
    numexo = 4
    Unload Menu_leçon4
    tempo = Dir(vpath & "Leçons\" & nivoRep & "\leçon4E.txt")
    If tempo = "" Then
ML50:
        pagenum = 0
        msgtext0 = CRLF + msgNofic & vpath & "Leçons\" & nivoRep & "\leçon4E.txt. " + perso_methode + pressez
        Msgform.Show 1
...
ML51:
    ...
    If msgf = 1 Then
        ...
        ' Go
        leçon4.Caption = bannerLeçon & " 4 E."
        leçon4.Show 1
    End If
    If msgf = 0 Then Menu_leçon4.Show 1
End If
...
If list1.ListIndex = 5 Then
    numexo = 5
    Unload Menu_leçon4
    tempo = Dir(vpath & "Leçons\" & nivoRep & "\leçon4F.txt")
    If tempo = "" Then
ML60:
        pagenum = 0
        msgtext0 = CRLF + msgNofic & vpath & "Leçons\" & nivoRep & "\leçon4F.txt. " + perso_methode + pressez
        Msgform.Show 1
...
ML61:
    ...
    If msgf = 1 Then
        ...
        ' Go
        leçon4.Caption = bannerLeçon & " 4 F."   'Dictionnaire pour Jaws sinon prononce franc
        leçon4.Show 1
    End If
    If msgf = 0 Then Menu_leçon4.Show 1
End If
...
If list1.ListIndex = 6 Then
    numexo = 6
    Unload Menu_leçon4
    tempo = Dir(vpath & "Leçons\" & nivoRep & "\leçon4G.txt")
    If tempo = "" Then
ML70:
        pagenum = 0
        msgtext0 = CRLF + msgNofic & vpath & "Leçons\" & nivoRep & "\leçon4G.txt. " + perso_methode + pressez
        Msgform.Show 1
...
ML71:
    ...
    If msgf = 1 Then
        ...
        ' Go
        leçon4.Caption = bannerLeçon & " 4 G."   'Dictionnaire pour Jaws sinon prononce gramme
        leçon4.Show 1
    End If
    If msgf = 0 Then Menu_leçon4.Show 1
End If
...
If list1.ListIndex = 7 Then
    numexo = 7
    Unload Menu_leçon4
    tempo = Dir(vpath & "Leçons\" & nivoRep & "\leçon4H.txt")
    If tempo = "" Then
ML80:
        pagenum = 0
        msgtext0 = CRLF + msgNofic & vpath & "Leçons\" & nivoRep & "\leçon4H.txt. " + perso_methode + pressez
        Msgform.Show 1
...
ML81:
    ...
    If msgf = 1 Then
        ...
        ' Go
        leçon4.Caption = bannerLeçon & " 4 H."   'Dictionnaire pour Jaws sinon prononce heure
        leçon4.Show 1
    End If
    If msgf = 0 Then Menu_leçon4.Show 1
End If
...
If Keycode = 91 Or Keycode = 92 Then Module_routines.cancelwin 0, Menu_leçon4, 1
End Sub
