VERSION 4.00
Begin VB.Form Menu_leçon9 
   BackColor       =   &H00C0C0C0&
   Caption         =   "Menu leçon 9"
   ClientHeight    =   5625
   ClientLeft      =   570
   ClientTop       =   1980
   ClientWidth     =   9960
   ...
   Begin VB.ListBox List1 
      ...
      EndProperty
      Height          =   2130
      ItemData        =   "Menu_leçon9.frx":0000
      Left            =   0
      List            =   "Menu_leçon9.frx":0002
      TabIndex        =   0
      Top             =   600
      Width           =   9495
   End
   ...
   End
End
Attribute VB_Name = "Menu_leçon9"
Attribute VB_Creatable = False
Attribute VB_Exposed = False
'*******************************  LOAD  ************************************************
' MENU : Ponctuations du haut
Private Sub Form_Load()
If FullScreenSwitch = 1 Then WindowState = 2
Menu_leçon9.Quitter.Caption = msgQuitterMP & msgÉchap

'Paramètres
If numleçon <> 11 Then numexo = 0
numleçon = 11   ' Toujours leçon n + 2
Set menu_courant = Menu_leçon9
Set menu_suivant = Menu_leçon10
Module_routines.Colors Menu_leçon9  '12/2011
Module_routines.Dimension Menu_leçon9
Module_menus.menu_reset "menu_leçon9.txt"
Module_routines.menu_refresh "menu_courant.txt", Menu_leçon9
Module_routines.mshow Menu_leçon9
Label3.Caption = bannerVersion & ", " & bannerCopyright
Module_routines.niveaux
Module_routines.MenuEditorTrans Menu_leçon9
...
Menu_leçon9.Caption = debexplivalue & bannerMenu & debgenvalue & bannerLeçon & " 9"
Menu_leçon9.label1.Caption = msgChoisissez
...
'****************  EXERCICE 9A ********************************************
' MENU : Les signes AuCarré et Écommercial
If list1.ListIndex = 0 Then
    numexo = 0  ' 0 pour A
    Unload Menu_leçon9
    tempo = Dir(vpath & "Leçons\" & nivoRep & "\leçon9A.txt")
    If tempo = "" Then
ML10:
        pagenum = 0
        msgtext0 = CRLF + msgNofic & vpath & "Leçons\" & nivoRep & "\leçon9A.txt. " + perso_methode + pressez
        Msgform.Show 1
...
ML12:
        ...
        If msgf = 1 Then
            ...
            Leçon5.Caption = bannerLeçon & " 9 A."
            Leçon5.Show 1
        End If
    End If
    If msgf = 0 Then Menu_leçon9.Show 1
End If

'****************  EXERCICE 9B ********************************************
' MENU : Guillemet, apostrophe, parenthèse, tiret
If list1.ListIndex = 1 Then
    numexo = 1
    Unload Menu_leçon9
    tempo = Dir(vpath & "Leçons\" & nivoRep & "\leçon9B.txt")
    If tempo = "" Then
ML20:
        pagenum = 0
        msgtext0 = CRLF + msgNofic & vpath & "Leçons\" & nivoRep & "\leçon9B.txt. " + perso_methode + pressez
        Msgform.Show 1
...
ML23:
            ...
            If msgf = 1 Then
                ...
                ' Go
                pasdepoint = 1
                leçonfontsize = 28 * zoomvalue  '12/2011
                Leçon5.Caption = bannerLeçon & " 9 B."
                Leçon5.Show 1
            End If
        End If
    End If
...
'****************  EXERCICE 9C ********************************************
' MENU : Le souligné et la parenthèse droite
If list1.ListIndex = 2 Then
    numexo = 2
    Unload Menu_leçon9
    tempo = Dir(vpath & "Leçons\" & nivoRep & "\leçon9C.txt")
    If tempo = "" Then
ML30:
        pagenum = 0
        msgtext0 = CRLF + msgNofic & vpath & "Leçons\" & nivoRep & "\leçon9C.txt. " + perso_methode + pressez
        Msgform.Show 1
...
ML32:
        ...
        If msgf = 1 Then
            ...
            Leçon5.Caption = bannerLeçon & " 9 C."
            Leçon5.Show 1
        End If
    End If
    If msgf = 0 Then Menu_leçon9.Show 1
...
'****************  EXERCICE 9D ********************************************
' MENU : Le ç, Degré, Égal, Plus
If list1.ListIndex = 3 Then
    numexo = 3
    Unload Menu_leçon9
    tempo = Dir(vpath & "Leçons\" & nivoRep & "\leçon9D.txt")
    If tempo = "" Then
ML40:
        pagenum = 0
        msgtext0 = msgNofic & vpath & "Leçons\" & nivoRep & "\leçon9D.txt. " + perso_methode + pressez
        Msgform.Show 1
...
ML42:
        ...
        If msgf = 1 Then
            ...
            pasdepoint = 1
            leçonfontsize5 = 28 * zoomvalue  '12/2011
            Leçon5.Caption = bannerLeçon & " 9 D."
            Leçon5.Show 1
        End If
    End If
    If msgf = 0 Then Menu_leçon9.Show 1
...
If Keycode = 91 Or Keycode = 92 Then Module_routines.cancelwin 0, Menu_leçon9, 1
End Sub
