VERSION 4.00
Begin VB.Form Menu_leçon10 
   BackColor       =   &H00C0C0C0&
   Caption         =   "Menu leçon 10"
   ClientHeight    =   5625
   ClientLeft      =   600
   ClientTop       =   1935
   ClientWidth     =   9885
   ...
   Begin VB.ListBox List1 
      ...
      EndProperty
      Height          =   1785
      ItemData        =   "Menu_leçon10.frx":0000
      Left            =   120
      List            =   "Menu_leçon10.frx":0002
      TabIndex        =   0
      Top             =   1080
      Width           =   7605
   End
   ...
   End
End
Attribute VB_Name = "Menu_leçon10"
Attribute VB_Creatable = False
Attribute VB_Exposed = False
'*******************************  LOAD  ************************************************
' MENU : Les chiffres au clavier principal
Private Sub Form_Load()
If FullScreenSwitch = 1 Then WindowState = 2
Menu_leçon10.Quitter.Caption = msgQuitterMP & msgÉchap

'Paramètres
If numleçon <> 12 Then numexo = 0
numleçon = 12   ' Toujours leçon n + 2
Set menu_courant = Menu_leçon10
Set menu_suivant = Menu_leçon11
Module_routines.Colors Menu_leçon10  '12/2011
Module_routines.Dimension Menu_leçon10
Module_menus.menu_reset "menu_leçon10.txt"
Module_routines.menu_refresh "menu_courant.txt", Menu_leçon10
Module_routines.mshow Menu_leçon10
Label3.Caption = bannerVersion & ", " & bannerCopyright
Module_routines.niveaux
Module_routines.MenuEditorTrans Menu_leçon10
...
Menu_leçon10.Caption = debexplivalue & bannerMenu & debgenvalue & bannerLeçon & " 10"
Menu_leçon10.label1.Caption = msgChoisissez
...
'****************  EXERCICE 10A ********************************************
' MENU : Les 4 premiers chiffres
If list1.ListIndex = 0 Then
    numexo = 0  ' 0 pour A
    Unload Menu_leçon10
    tempo = Dir(vpath & "Leçons\" & nivoRep & "\leçon10A.txt")
    If tempo = "" Then
ML10:
        pagenum = 0
        msgtext0 = CRLF + msgNofic & vpath & "Leçons\" & nivoRep & "\leçon10A.txt. " + perso_methode + pressez
        Msgform.Show 1
...
ML11:
    pagenum = 1
    msgtext0 = CRLF + pg10a1 + pressez
    Msgform.Show 1
    If msgf = 33 Then Beep
    If msgf = 2 Or msgf = 33 Then GoTo ML11
    If msgf = 1 Or msgf = 34 Then  '12/2011 rectif
ML12:
        pagenum = 2
        msgtext0 = CRLF + pg10a2 + pressez
        Msgform.Show 1
...
ML13:
            pagenum = 3: pagemax = 1
            msgtext0 = CRLF + pg10a3 + pressez
            Msgform.Show 1
            If msgf = 33 Then GoTo ML12
            If msgf = 34 Then Beep
            If msgf = 2 Or msgf = 34 Then GoTo ML13
            If msgf = 1 Then
                exo_courant = "leçon10A.txt"
                    
                ' Msg d'encouragements et d'explications
                Module_routines.resetmsg
                msgtext2(19) = CRLF + pg10am1
                msgtext2(29) = CRLF + pg10am2
                    
                ' Go
                leçonfontsize5 = 36 * zoomvalue  '12/2011
                Leçon5.Caption = bannerLeçon & " 10 A."
                Leçon5.Show 1
            End If
        End If
    End If
    If msgf = 0 Then Menu_leçon10.Show 1
End If

'****************  EXERCICE 10B ********************************************
' MENU : chiffres de 5 à 7
If list1.ListIndex = 1 Then
    numexo = 1
    Unload Menu_leçon10
    tempo = Dir(vpath & "Leçons\" & nivoRep & "\leçon10B.txt")
    If tempo = "" Then
ML20:
        pagenum = 0
        msgtext0 = CRLF + msgNofic & vpath & "Leçons\" & nivoRep & "\leçon10B.txt. " + perso_methode + pressez
        Msgform.Show 1
...
ML23:
            pagenum = 3: pagemax = 1
            msgtext0 = CRLF + pg10b3 + pressez
            Msgform.Show 1
            If msgf = 33 Then GoTo ML22
            If msgf = 34 Then Beep  '12/2011 rectif
            If msgf = 2 Or msgf = 34 Then GoTo ML23
            If msgf = 1 Then
                exo_courant = "leçon10B.txt"
            
                ' Msg d'encouragements et d'explications
                Module_routines.resetmsg
                msgtext2(14) = CRLF + pg10bm1
                msgtext2(27) = CRLF + pg10bm2
            
                ' Go
                leçonfontsize5 = 28 * zoomvalue  '12/2011
                Leçon5.Caption = bannerLeçon & " 10 B."
                Leçon5.Show 1
            End If
        End If
    End If
...
'****************  EXERCICE 10C ********************************************
' MENU : Les chiffres 8, 9, 0
If list1.ListIndex = 2 Then
    numexo = 2
    Unload Menu_leçon10
    tempo = Dir(vpath & "Leçons\" & nivoRep & "\leçon10C.txt")
    If tempo = "" Then
ML30:
        pagenum = 0
        msgtext0 = CRLF + msgNofic & vpath & "Leçons\" & nivoRep & "\leçon10C.txt. " + perso_methode + pressez
        Msgform.Show 1
...
ML32:
        ...
        If msgf = 1 Then
            ...
            ' Go
            leçonfontsize5 = 28 * zoomvalue  '12/2011
            Leçon5.Caption = bannerLeçon & " 10 C."
            Leçon5.Show 1
        End If
    End If
    If msgf = 0 Then Menu_leçon10.Show 1
...
If Keycode = 91 Or Keycode = 92 Then Module_routines.cancelwin 0, Menu_leçon10, 1
End Sub
